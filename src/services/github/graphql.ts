...
const LicenseFragmentDoc: DocumentNode = {
  kind: 'Document',
  definitions: [
    {
...
const ReleaseFragmentDoc: DocumentNode = {
  kind: 'Document',
  definitions: [
    {
      kind: 'FragmentDefinition',
      ...
      selectionSet: {
        ...
        selections: [
          ...
          {
            kind: 'Field',
            name: { kind: 'Name', value: 'resourcePath' },
            arguments: [],
            directives: [],
          },
        ],
...
const TopicFragmentDoc: DocumentNode = {
  kind: 'Document',
  definitions: [
    {
      kind: 'FragmentDefinition',
...
const RepositoryTopicFragmentDoc: DocumentNode = {
  kind: 'Document',
  definitions: [
    {
      kind: 'FragmentDefinition',
      name: { kind: 'Name', value: 'RepositoryTopic' },
      typeCondition: {
        kind: 'NamedType',
        name: { kind: 'Name', value: 'RepositoryTopic' },
      },
...
const RepositoryFragmentDoc: DocumentNode = {
  kind: 'Document',
  definitions: [
    {
      kind: 'FragmentDefinition',
      ...
      selectionSet: {
        ...
        selections: [
          ...
          {
            kind: 'Field',
            name: { kind: 'Name', value: 'sshUrl' },
            arguments: [],
            directives: [],
          },
          {
            kind: 'Field',
            name: { kind: 'Name', value: 'usesCustomOpenGraphImage' },
            arguments: [],
            directives: [],
          },
          {
          ...
          {
            kind: 'Field',
            name: { kind: 'Name', value: 'repositoryTopics' },
            arguments: [
              {
                kind: 'Argument',
                name: { kind: 'Name', value: 'last' },
...
const UserFragmentDoc: DocumentNode = {
  kind: 'Document',
  definitions: [
    {
      kind: 'FragmentDefinition',
          ...
          },
          {
            ...
            arguments: [
              ...
              },
              {
                ...
                value: {
                  kind: 'ListValue',
                  values: [{ kind: 'EnumValue', value: 'REPOSITORY' }],
                },
              },
            ],
            directives: [],
...
const GetUserDocument: DocumentNode = {
  kind: 'Document',
  definitions: [
    {
...
const getSdk = (
  ...
  return {
    GetUser(variables: GetUserQueryVariables): Promise<GetUserQuery> {
      return withWrapper(() =>
        client.request<GetUserQuery>(print(GetUserDocument), variables)
      )
    },
  }
}
const getSdkWithHooks = (
  client: GraphQLClient,
  withWrapper: SdkFunctionWrapper = defaultWrapper
) => {
...
export type LicenseFragment = { __typename?: 'License' } & Pick<
  License,
  'id' | 'key' | 'name' | 'nickname' | 'url' | 'body' | 'description'
>
...
export type RepositoryFragment = { __typename?: 'Repository' } & Pick<
  ...
  | 'isTemplate'
> & {
    licenseInfo: Maybe<{ __typename?: 'License' } & LicenseFragment>
    releases: { __typename?: 'ReleaseConnection' } & {
      nodes: Maybe<Array<Maybe<{ __typename?: 'Release' } & ReleaseFragment>>>
    }
    repositoryTopics: { __typename?: 'RepositoryTopicConnection' } & {
      nodes: Maybe<
        Array<
          Maybe<{ __typename?: 'RepositoryTopic' } & RepositoryTopicFragment>
        >
      >
    }
  }
export type RepositoryTopicFragment = { __typename?: 'RepositoryTopic' } & Pick<
  RepositoryTopic,
  'id' | 'url' | 'resourcePath'
> & { topic: { __typename?: 'Topic' } & TopicFragment }
export type TopicFragment = { __typename?: 'Topic' } & Pick<
  Topic,
    ...
    pinnedItems: { __typename?: 'PinnableItemConnection' } & {
      nodes: Maybe<
        Array<
          Maybe<
            | { __typename?: 'Gist' }
            | ({ __typename?: 'Repository' } & RepositoryFragment)
          >
        >
      >
    }
